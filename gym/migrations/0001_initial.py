# Generated by Django 3.0.5 on 2022-07-18 09:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gym.Customer')),
                ('mechanic', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gym.Mechanic')),
            ],
        ),
        migrations.CreateModel(
            name='Attendance',
